...
|1| [Система прогнозирования HR-рисков: предсказание удовлетворенности и оттока персонала]() | Разработка комплексной системы машинного обучения для HR-департамента, направленной на решение двух ключевых задач кадрового менеджмента |*matplotlib, numpy, pandas, seaborn, shap, lightgbm, phik, sklearn* |